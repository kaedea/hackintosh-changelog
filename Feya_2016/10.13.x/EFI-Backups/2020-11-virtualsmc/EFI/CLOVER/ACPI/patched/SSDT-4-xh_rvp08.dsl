 ...
 *
 * Disassembly of SSDT-4-xh_rvp08.aml, Sun Jan 28 00:40:15 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00000B19 (2841)
 *     Revision         0x02
 *     Checksum         0x54
 *     OEM ID           "INTEL"
...
DefinitionBlock ("", "SSDT", 2, "INTEL", "xh_rvp08", 0x00000000)
{
    ...
    Scope (\_SB.PCI0.XHC.RHUB.HS02)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Return (GPLD (DerefOf (Index (UHSD, One)), One))
        }
    }
    ...
    Scope (\_SB.PCI0.XHC.RHUB.HS03)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Return (GPLD (DerefOf (Index (UHSD, 0x02)), 0x02))
        }
    }
    ...
    Scope (\_SB.PCI0.XHC.RHUB.HS04)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Return (GPLD (DerefOf (Index (UHSD, 0x03)), 0x02))
        }
    }
    ...
    Scope (\_SB.PCI0.XHC.RHUB.HS05)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Return (GPLD (DerefOf (Index (UHSD, 0x04)), 0x03))
        }
    }
    ...
    Scope (\_SB.PCI0.XHC.RHUB.HS06)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Return (GPLD (DerefOf (Index (UHSD, 0x05)), 0x03))
        }
    }
    ...
    Scope (\_SB.PCI0.XHC.RHUB.HS07)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Return (GPLD (DerefOf (Index (UHSD, 0x06)), 0x04))
        }
    }
    ...
    Scope (\_SB.PCI0.XHC.RHUB.HS08)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Return (GPLD (DerefOf (Index (UHSD, 0x07)), 0x04))
        }
    }
    ...
    Scope (\_SB.PCI0.XHC.RHUB.HS09)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Return (GPLD (DerefOf (Index (UHSD, 0x08)), 0x05))
        }
    }
    ...
    Scope (\_SB.PCI0.XHC.RHUB.HS10)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Return (GPLD (DerefOf (Index (UHSD, 0x09)), 0x05))
        }
    }
    ...
    If (LEqual (PCHV (), SPTH))
    {
        Scope (\_SB.PCI0.XHC.RHUB.HS11)
        {
            ...
            Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
            {
                Return (GPLD (DerefOf (Index (UHSD, 0x0A)), 0x06))
            }
        }
        ...
        Scope (\_SB.PCI0.XHC.RHUB.HS12)
        {
            ...
            Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
            {
                Return (GPLD (DerefOf (Index (UHSD, 0x0B)), 0x06))
            }
        }
        ...
        Scope (\_SB.PCI0.XHC.RHUB.HS13)
        {
            ...
            Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
            {
                Return (GPLD (DerefOf (Index (UHSD, 0x0C)), 0x07))
            }
        }
        ...
        Scope (\_SB.PCI0.XHC.RHUB.HS14)
        {
            ...
            Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
            {
                Return (GPLD (DerefOf (Index (UHSD, 0x0D)), 0x07))
            }
        }
    }
    ...
    Scope (\_SB.PCI0.XHC.RHUB.SS02)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Return (GPLD (DerefOf (Index (USSD, One)), One))
        }
    }
    ...
    Scope (\_SB.PCI0.XHC.RHUB.SS03)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Return (GPLD (DerefOf (Index (USSD, 0x02)), 0x02))
        }
    }
    ...
    Scope (\_SB.PCI0.XHC.RHUB.SS04)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Return (GPLD (DerefOf (Index (USSD, 0x03)), 0x02))
        }
    }
    ...
    Scope (\_SB.PCI0.XHC.RHUB.SS05)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Return (GPLD (DerefOf (Index (USSD, 0x04)), 0x03))
        }
    }
    ...
    Scope (\_SB.PCI0.XHC.RHUB.SS06)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Return (GPLD (DerefOf (Index (USSD, 0x05)), 0x03))
        }
    }
    ...
    If (LEqual (PCHV (), SPTH))
    {
        Scope (\_SB.PCI0.XHC.RHUB.SS07)
        {
            ...
            Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
            {
                Return (GPLD (DerefOf (Index (USSD, 0x06)), 0x04))
            }
        }
        ...
        Scope (\_SB.PCI0.XHC.RHUB.SS08)
        {
            ...
            Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
            {
                Return (GPLD (DerefOf (Index (USSD, 0x07)), 0x04))
            }
        }
        ...
        Scope (\_SB.PCI0.XHC.RHUB.SS09)
        {
            ...
            Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
            {
                Return (GPLD (DerefOf (Index (USSD, 0x08)), 0x05))
            }
        }
        ...
        Scope (\_SB.PCI0.XHC.RHUB.SS10)
        {
            ...
            Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
            {
                Return (GPLD (DerefOf (Index (USSD, 0x09)), 0x05))
            }
        }
